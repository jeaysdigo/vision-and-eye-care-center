            ...
            <form action="#">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <p class="p-2.5 bg-gray-50 rounded-md  text-gray-900 sm:text-sm dark:text-white"><?php echo htmlspecialchars($occupation); ?></p>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="py-2 col-span-6 sm:col-full">
                        <a href="account.php" class="md:px-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            Edit Profile
                        </a>
                    </div>
                </div>

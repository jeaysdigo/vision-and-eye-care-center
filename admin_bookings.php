                ...
                <tbody>
                    <?php if (!empty($appointments)): ?>
                        <?php foreach ($appointments as $appointment): ?>
                            ...
                            <td class="px-6 py-4">
                            <?= date('F j, Y g:i A', strtotime($appointment['AppointmentDate'] . ' UTC')); ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button type="button" data-modal-toggle="delete-user-modal" data-appointment-id="<?= htmlspecialchars($appointment['AppointmentID']) ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO doctors (FirstName, LastName, Email, Password, DateOfBirth, Gender, ContactNumber, Address, Municipality, City, ZipCode)
            VALUES ('$first_name', '$last_name', '$email', '$password', '$bday', '$gender', '$contact', '$address', '$municipality', '$city', '$zipcode')";

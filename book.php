...
<body>
  ...
  <div class="mx-auto max-w-md flex-col items-center justify-center px-2 py-2 mx-auto md:h-screen lg:py-0">
    ...
    <input datepicker datepicker-autohide type="text" id="datePicker" required="required" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
    </div>
</div>
...
<div class="p-4 pt-0">
    ...
    <button id="save-button" type="button" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Book Now</button>
</div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    html: 'Successfully scheduled on <b>'+ formData.selectedDate + '</b> at <b>' + formData.selectedTime12h + '</b>',
